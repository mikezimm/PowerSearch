...
import * as strings from 'AlvSearchWebPartStrings';
import AlvSearch from './components/AlvSearch';
import { IAlvSearchProps } from './components/IAlvSearchProps';
import { IAlvSearchWebPartProps } from './IAlvSearchWebPartProps';
...
export default class AlvSearchWebPart extends FPSBaseClass<IAlvSearchWebPartProps> {
  ...
  public render(): void {
    ...
    const element: React.ReactElement<IAlvSearchProps> = React.createElement(
      AlvSearch,
      {
